...
RequestResult.unserialize = function(serializedRequestResult) {
	var objResult = JSON.parse(serializedRequestResult),
...
RequestProxy.prototype = {
	...
	onBackendError : function(error) {
		...
		{
			this.originResponse.writeHead(500, {
				"Content-Type": "text/plain"
			});

			this.originResponse.write('Internal Server Error');
		}
